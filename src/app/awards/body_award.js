...
//      "Represented Dubai College in the STEM Challenge 2025, hosted by Curtin University in partnership with Lab of the Future, and placed among the Top 30 teams.",
...
//      "Successfully competed in Dubai College’s Estimathon — a high-intensity problem-solving event that combines mathematical reasoning, estimation, and teamwork.",
//         },
//       {
...
//      "An international competition that promotes computational thinking through a set of logic-based challenges. Achieved a placement in the 99.79 percentile and earned Best in School recognition for exceptional performance."
...
//         description:
//           "Achieved strong results in the Chemistry Olympiad and the Avogadro Chemistry Contest, both known for their rigorous, university-level problem sets. "
//       }
//     ]
//   },
//   {
      ...
      items: [
        {
          ...
          description: [
            ...
            "As an Ambassador of Change for TCF, played a pivotal role in a team initiative that raised AED 100,000 to support education for underprivileged children in Pakistan;",
            "This funding fully covered the annual operational costs of two TCF schools, opening the doors of learning to nearly 200 students for an entire year;",
  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-1/3 flex flex-col items-start">
        ...
        <a
          href="https://www.linkedin.com/in/humayl-fazal-3b1a11240"
          target="_blank"
          rel="noopener noreferrer"
          className="mb-4 bg-[#eccc93] mx-auto text-[#1a334c] font-semibold py-2 px-4 rounded-lg transition duration-300 w-full md:w-auto"
        >
