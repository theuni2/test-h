...
export default function Gallery() {
  ...
  const rover = [
    { src: '/image/sea_rover/1.JPG', alt: 'Rover' },
    { src: '/image/sea_rover/2.JPG', alt: 'Rover' },
    { src: '/image/sea_rover/3.JPG', alt: 'Rover' },
    { src: '/image/sea_rover/4.PNG', alt: 'Rover' },
    { src: '/image/sea_rover/5.jpg', alt: 'Rover' },
    { src: '/image/sea_rover/6.JPG', alt: 'Rover' },
    // { src: '/images/polo.jpg', alt: 'Water polo match' },
  ];
  const kenken = [
