...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#d6d6d6] border-t border-gray-200 text-blue-950 body-font">
      <div className="container px-5 py-8 mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        >
          ...
          <span
            className={`ml-2 text-lg font-semibold text-blue-950 ${ptSerif.className}`}
          >
            Humayl Fazal
          </span>
        </Link>
  ...
  <a
    ...
    className="flex flex-row items-center hover:underline text-gray-600 font-medium"
  >
    <Newspaper className="w-6 h-6 mr-2 text-gray-500" />
